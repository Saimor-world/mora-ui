...
export const ROLE_DEFINITIONS: Record<RoleKey, RoleDefinition> = {
  owner: {
    ...
    homeMessage: 'Môra zeigt Resonanzlinien & Risiken, hält den Kontext deiner Auswahl und simuliert den Raum mit Demo-Daten – später mit euren echten Quellen.',
  ...
  department: {
    ...
    homeMessage: 'Môra filtert eure Linie, merkt sich den Fokus und zeigt Team-Pulse – jetzt mit Demo-Daten, später mit euren Streams.',
  ...
  member: {
    ...
    homeMessage: 'Môra hält deinen aktuellen Kontext über Field, Folder und Chat – Demo-Objekte zeigen die Spur, später deine echten Dokumente.',
  ...
  admin: {
    ...
    homeMessage: 'Môra überwacht Verbindungen, Adapter und Synchronisation, hält Kontext über Auswahl – Demo-Modus heute, später eure echten Adapter.',
