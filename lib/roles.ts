...
export const ROLE_DEFINITIONS: Record<RoleKey, RoleDefinition> = {
  owner: {
    ...
    homeMessage: 'Môra zeigt Dir, wie Informationen zusammenhängen, und simuliert einen ruhigen Demo-Raum – später mit Euren echten Quellen.',
  ...
  department: {
    ...
    homeMessage: 'Môra filtert, was eure Linie betrifft: Demo-Daten zeigen ein Beispiel-Team, später laufen hier eure Quellen.',
  ...
  member: {
    ...
    homeMessage: 'Môra merkt sich, womit du arbeitest, und hält Wichtiges griffbereit. Demo-Objekte zeigen, wie sich das anfühlt.',
  ...
  admin: {
    ...
    homeMessage: 'Môra überwacht Verbindungen, Adapter und Synchronisation, heute im Demo-Modus – später mit euren echten Adaptern.',
