...
const VISUAL: TunnelEntry[] = [
  {
    id: 'mora-orb',
    title: 'Der Orb (Glas + Plasma-Herz)',
    category: 'visual',
    preview: 'component',
    componentKey: 'MoraOrb',
    status: 'live',
    location: 'components/mora/MoraOrb.tsx — Home, LockScreen, ResonanceRoom …',
    whyHidden: 'DER kanonische Orb. Flüssig-morphender Glas-Hub + atmende Corona um das Plasma-Herz. (LiquidOrb 3D/WebGL entfernt — flüssiges Gefühl jetzt 2D.)',
    keepVisual: true,
  },
  {
    id: 'plasma-orb',
    title: 'Plasma-Herz (intern)',
    category: 'visual',
    preview: 'component',
    componentKey: 'PlasmaOrb',
    status: 'live',
    location: 'components/mora/PlasmaOrb.tsx — das Herz von „Der Orb"',
    whyHidden: 'Interne Schicht: 2D-Canvas-Plasma (SimplexNoise, FPS-gedeckelt). Hier isoliert zur Inspektion.',
    keepVisual: true,
  },
  {
    id: 'starfield',
  ...
  {
    id: 'semantic-constellation',
    title: 'Semantic Constellation',
    category: 'visual',
    preview: 'component',
    componentKey: 'SemanticConstellation',
    status: 'orphan',
    location: 'components/visual/SemanticConstellation.tsx',
    whyHidden: 'Phase 6.1 Komponente — semantic-layer-anchor nicht montiert',
    keepVisual: true,
    problem: 'Benötigt DOM-Anker #semantic-layer-anchor (z-5)',
    solution: 'In NavLayer oder DepartmentSurface integrieren mit echten Node-Positionen',
    tags: ['semantic', 'navigation'],
  },
  {
    id: 'orbital-canvas',
    title: 'Orbital Canvas',
    category: 'visual',
    preview: 'component',
    componentKey: 'OrbitalCanvas',
    status: 'orphan',
    location: 'components/visual/OrbitalCanvas.tsx',
    whyHidden: 'Universe-Visualisierung — kein Einstiegspunkt verdrahtet',
    keepVisual: true,
    problem: 'Benötigt OrbitalBody[] aus echten Abteilungs-Daten',
    solution: 'In UniverseView oder Space-Layer einbinden',
    tags: ['universe', 'navigation'],
  },
  {
    id: 'mora-playground',
...
const ORGANIC: TunnelEntry[] = [
  {
    id: 'mycelium-overlay',
    title: 'Mycelium Neural Overlay (V9)',
    category: 'organic',
    preview: 'component',
    componentKey: 'MyceliumOverlay',
    status: 'live',
    location: 'components/organic/MyceliumOverlay.tsx',
    whyHidden: 'Aktiv im Shell — hier isoliert zur Inspektion (z-1, mix-blend: screen)',
    keepVisual: true,
    tags: ['ambient', 'background', 'neural'],
  },
  {
    id: 'mycelium-25d',
    title: 'Mycelium 2.5D (Folder Network)',
    category: 'organic',
    preview: 'component',
    componentKey: 'Mycelium25D',
    status: 'orphan',
    location: 'components/organic/Mycelium25D.tsx',
    whyHidden: 'Folder-Netzwerk ohne aktiven Einstiegspunkt',
    keepVisual: true,
    problem: 'Nutzt deprecated MyceliumNode — Migration unvollständig',
    solution: 'In DepartmentLayer oder UniverseView einbinden mit echten Folder-Nodes',
    tags: ['mycelium', 'folders', '2.5d'],
  },
  {
    id: 'mycelium-field-3d',
    title: 'Mycelium Field 3D (Three.js)',
    category: 'organic',
    preview: 'component',
    componentKey: 'MyceliumField3D',
    status: 'orphan',
    location: 'components/organic/MyceliumField3D.tsx',
    whyHidden: 'Three.js / R3F Rendering — zu schwer für Standard-Shell-Layer',
    keepVisual: true,
    problem: 'Benötigt @react-three/fiber + drei; keine Abteilungs-Nodes angeschlossen',
    solution: 'Als dedizierte 3D-Ansicht oder Space-Layer im Universe einbinden',
    tags: ['three.js', 'r3f', '3d', 'mycelium'],
  },
  {
    id: 'mycelium-layer',
    ...
    whyHidden: 'Nicht im aktuellen Nav-Flow eingebunden',
    keepVisual: true,
    problem: 'Bereits auf useNavStore + usePaneStore umgestellt — nur nicht in einer Surface verdrahtet',
    solution: 'Als eigene Space-Layer/Visualisierung einbinden oder als „Museum“ behalten',
  },
  {
    id: 'ambient-dust',
    title: 'Ambient Dust',
...
export const TUNNEL_PRODUCT_ISSUES: TunnelEntry[] = [
  ...
  },
  {
    ...
    status: 'orphan',
    location: 'organic/*',
    whyHidden: 'Legacy-State — bereits migriert',
    problem: 'activeNodeId kommt inzwischen aus usePaneStore/lokalem State, nicht mehr aus moraState.',
    solution: 'Migration abgeschlossen; visuelle Mycelium-Layer bleiben im Tunnel bis sie in eine Surface verdrahtet werden.',
  },
  {
    id: 'mora-memory-chat',
