...
function paneEntries(): TunnelEntry[] {
  const inPaneManager = new Set([
    ...
    'apps', 'timeline', 'tasks', 'canvas', 'space',
  ]);
...
export const TUNNEL_PRODUCT_ISSUES: TunnelEntry[] = [
  ...
  },
  {
    ...
    whyHidden: 'future-tier + fehlender PaneManager-case',
    problem: 'Mora erzeugt Pläne, openPane feuert, aber nichts rendert.',
    solution: 'PaneManager case work-session + Tier-Entscheidung (promote vs. flag).',
  },
  {
    ...
    whyHidden: 'Aus Launcher ausgeschlossen; PaneManager case fehlt',
    problem: 'action-center ist app-tier, aber PaneManager rendert es nicht.',
    solution: "case 'action-center': return <ActionCenterPane …> in PaneManager.",
  },
  {
    id: 'failing-tests',
