...
// ── Types (defined in moraTypes.ts, imported + re-exported here for backward compat) ──
import type {
    MoraState,
    ViewLevel,
    ViewMode,
    ...
    UserRole,
    User,
    OperationalSessionPatch,
    Permissions,
} from './moraTypes';
import { ROLE_PERMISSIONS, getPermissions } from './moraTypes';
